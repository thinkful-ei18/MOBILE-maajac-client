...
export class MapWrapper extends Component {
	...
	markerImage(type) {
		if (type === 'Theft') {
			return <Image style={styles.marker} source={require('../../assets/map_icon_theft.png')} />;
		} else if (type === 'Accident') {
			return <Image style={styles.marker} source={require('../../assets/map_icon_accident.png')} />;
		} else if (type === 'Crime') {
			return <Image style={styles.marker} source={require('../../assets/map_icon_crime.png')} />;
		} else if (type === 'Other') {
			return <Image style={styles.marker} source={require('../../assets/map_icon_other.png')} />;
		} else if (type === 'Road-Construction') {
			return <Image style={styles.marker} source={require('../../assets/map_icon_traffic_construction.png')} />;
		}
	}
